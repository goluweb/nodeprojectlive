...
app.post('/addchapter',rolePermission('addChapter'),imageUpload.any(), async (req, res) => {
      ...
      const { course_id ,level_id , playlist ,startDate,endDate } = req.body;
      const { chapter_name, chapterDscription, mode, lesstionStartDate,lessionEndDate  } = req.body;
...
app.post('/editchapter/:id',rolePermission('editChapter'), async(req,res)=>{
    ...
    const { course_id ,level_id , playlist ,startDate,endDate,chapter_id } = req.body;
    const { chapter_name, chapterDscription, mode, lesstionStartDate,lessionEndDate  } = req.body;
